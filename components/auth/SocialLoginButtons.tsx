// ============================================================
// SocialLoginButtons — Apple + Google (UI-ready)
// ============================================================
// Reutilizável em Login (email + senha) e Cadastro.
// Backend TODO: BE-060 OAuth Apple, BE-061 OAuth Google
// ============================================================
'use client';
    ...
    <>
      ...
      <div className="flex gap-3">
        <button
          type="button"
          onClick={handleApple}
          className="flex-1 flex items-center justify-center gap-2 py-3 rounded-lg bg-white/[0.06] border border-white/[0.08] text-white/70 text-sm font-medium hover:bg-white/10 transition-colors active:scale-[0.98]"
        >
