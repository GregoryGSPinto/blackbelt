...
import { KEYPAD_KEYS, maskEmail, MOCK_VERIFY_CODE, PARENT_EMAIL } from './KidsGatekeeperLogic';
import { useKidsGatekeeper } from './useKidsGatekeeper';

export interface KidsGatekeeperProps {
  onSuccess: () => void;
  onCancel: () => void;
  isOpen: boolean;
...
export function KidsGatekeeper({
  ...
  const {
    ...
    verifyCode,
    isBioRunning,
  } = useKidsGatekeeper({ isOpen, onSuccess, t });
