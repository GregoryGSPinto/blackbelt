...
import { useOfflineCheckin } from '@/src/features/attendance/hooks/useOfflineCheckin';
import { OfflineBanner } from '@/components/shared/OfflineBanner';

// ── Lazy QR Scanner ──
const LazyQRScanner = dynamic(
  () => import('@/src/features/attendance/components/checkin/QRScanner').then(mod => mod.QRScanner),
