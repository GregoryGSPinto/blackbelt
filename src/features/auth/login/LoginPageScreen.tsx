...
function LoginContent() {
  ...
  const {
    ...
    sobreRef,
    step,
  } = useLoginController(!!shouldReduceMotion);
  ...
  // ─── Select demo user ─────────────────────────────────────
  const selectDemoUser = (demoUser: typeof DEMO_USERS[number]) => {
  ...
  const isLoginFlow = isLoginFlowStep(step);
              ...
              >
                ...
                >
                  ...
                  <LoginSocialButtons
                    ...
                    springTransition={SPRING_PREMIUM}
