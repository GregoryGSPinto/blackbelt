export function newStudentEmail(params: {
  studentName: string;
  studentEmail: string;
  plan: string;
  enrolledAt: string;
}): string {
  const { studentName, studentEmail, plan, enrolledAt } = params;
...
<head>
  ...
  <title>Novo aluno matriculado - BlackBelt</title>
</head>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 24px;font-size:16px;color:#d0d0e0;line-height:1.6;">
                Um novo aluno acabou de se matricular na sua academia. Confira os detalhes abaixo:
              </p>
                ...
                <tr>
                  <td style="padding:24px;">
                    <table role="presentation" cellpadding="0" cellspacing="0" style="width:100%;">
                      <tr>
                        <td style="padding:8px 0;font-size:14px;color:#a0a0b0;">Nome</td>
                        <td align="right" style="padding:8px 0;font-size:14px;color:#ffffff;font-weight:600;">${studentName}</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="padding:8px 0;font-size:14px;color:#a0a0b0;">Email</td>
                        <td align="right" style="padding:8px 0;font-size:14px;color:#f59e0b;">${studentEmail}</td>
                      </tr>
                      <tr>
                        <td colspan="2" style="padding:4px 0;">
                          <div style="height:1px;background-color:#333;"></div>
                      ...
                      <tr>
                        ...
                        <td align="right" style="padding:8px 0;font-size:14px;color:#ffffff;font-weight:600;">${plan}</td>
                      </tr>
                      <tr>
                        <td colspan="2" style="padding:4px 0;">
                          <div style="height:1px;background-color:#333;"></div>
                      ...
                      <tr>
                        <td style="padding:8px 0;font-size:14px;color:#a0a0b0;">Data</td>
                        <td align="right" style="padding:8px 0;font-size:14px;color:#ffffff;">${enrolledAt}</td>
                      </tr>
                    </table>
                  </td>
                </tr>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto;">
                <tr>
                  <td align="center" style="background-color:#f59e0b;border-radius:8px;">
                    <a href="https://blackbelt-five.vercel.app/admin/alunos"
