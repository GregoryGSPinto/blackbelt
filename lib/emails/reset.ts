export function resetPasswordEmail(params: { nome: string; resetUrl: string }): string {
...
<head>
  ...
  <title>Redefinir senha - BlackBelt</title>
</head>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 24px;font-size:16px;color:#d0d0e0;line-height:1.6;">
                Recebemos uma solicitacao para redefinir a senha da sua conta BlackBelt. Clique no botao abaixo para criar uma nova senha.
              </p>
              <p style="margin:0 0 32px;font-size:14px;color:#a0a0b0;line-height:1.6;">
                Este link expira em 1 hora. Se voce nao solicitou a redefinicao de senha, ignore este email. Sua senha atual permanecera inalterada.
              </p>
              ...
              <!-- Security notice -->
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:32px 0 0;width:100%;">
                <tr>
                  <td style="background-color:#1e1e35;border-left:4px solid #f59e0b;padding:16px;border-radius:0 8px 8px 0;">
                    <p style="margin:0;font-size:13px;color:#a0a0b0;line-height:1.5;">
                      <strong style="color:#f59e0b;">Dica de seguranca:</strong> O BlackBelt nunca pedira sua senha por email. Se voce nao reconhece esta solicitacao, altere sua senha imediatamente.
                    </p>
                  </td>
                </tr>
              </table>
