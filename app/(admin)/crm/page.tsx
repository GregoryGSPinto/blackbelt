    ...
    <div className="space-y-6">
        ...
        {TABS.map(tab => (
          <button
            ...
            style={{
              ...
              border: activeTab === tab.key ? '1px solid var(--accent)' : '1px solid var(--card-border)',
            }}
          >
            {tab.label}
          </button>
      ...
      {activeTab === 'metricas' && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="rounded-xl p-4" style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)', borderRadius: 12 }}>
          ...
          <div className="rounded-xl p-5" style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)', borderRadius: 12 }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {roiCards.map(card => (
                <div
                  ...
                  style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)', borderRadius: 12 }}
                >
                  <span className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>
                    {card.canal}
                  </span>
      ...
      {activeTab === 'indicacoes' && (
        <div className="space-y-6">
          ...
          {/* Indicacoes Table */}
          <div className="rounded-xl overflow-hidden" style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border)', borderRadius: 12 }}>
