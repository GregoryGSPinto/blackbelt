  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto">
        ...
        <div className="space-y-3">
          {[
            ...
            <label key={item.label} className="flex items-center justify-between py-2 cursor-pointer">
              <span className="text-sm font-teen" style={{ color: 'var(--text-primary)' }}>{item.label}</span>
      ...
      <div style={{ ...card, padding: '1.5rem' }}>
        ...
        <div className="space-y-4">
          {[
            ...
            { lbl: 'Confirmar', val: confirmar, set: setConfirmar },
          ].map((f) => (
            <div key={f.lbl}>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-11 rounded-xl text-sm outline-none font-teen"
          ...
          <button onClick={handleSaveSenha} disabled={saving}
            className="flex items-center gap-2 px-4 py-3 rounded-xl text-sm font-medium font-teen transition-colors disabled:opacity-40"
      ...
      <div style={{ ...card, padding: '1.5rem' }}>
        ...
        <p className="text-sm font-teen" style={{ color: 'var(--text-secondary)' }}>
