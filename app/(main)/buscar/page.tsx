  ...
  return (
    <div className="min-h-screen p-4 md:p-8">
      ...
      {isSearching ? (
        ...
        /* Sugestões */
        <div className="max-w-7xl mx-auto">
          <h2 className="text-xl sm:text-2xl font-semibold mb-6">Sugestões de Busca</h2>
          ...
          <div className="mt-12">
            <h2 className="text-xl sm:text-2xl font-semibold mb-6">Mais Buscados</h2>
              ...
              {maisBuscados.map((video) => (
                ...
                >
                  ...
                  <div className="relative aspect-video bg-black rounded-xl overflow-hidden mb-3 shadow-lg hover:shadow-2xl transition-all duration-300">
                    ...
                    {/* YouTube Badge */}
                    <div className="absolute top-2 left-2 bg-red-600 px-2.5 py-1 rounded-md text-xs font-medium shadow-lg">
                      YouTube
                    </div>
                  </div>
