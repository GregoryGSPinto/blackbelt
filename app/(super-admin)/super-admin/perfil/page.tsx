    ...
    <div className="space-y-6 max-w-4xl mx-auto px-4 md:px-0 pt-6 pb-8">
      ...
      <div style={{ ...card, padding: '1.5rem' }}>
        <div className="flex flex-col md:flex-row items-center gap-5 md:gap-8">
          <div className="w-24 h-24 md:w-32 md:h-32 rounded-xl flex items-center justify-center text-5xl md:text-6xl" style={{ background: 'var(--card-bg)', border: `1px solid ${tokens.cardBorder}` }}>
            {user?.avatar || '👤'}
          </div>
          <div className="text-center md:text-left">
            ...
            <p className="text-xs md:text-sm mt-1" style={{ color: 'var(--text-secondary)' }}>Super Administrador</p>
          </div>
        </div>
      </div>
