...
export default function InadimplenciaPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold" style={{ color: 'var(--text-primary)' }}>Inadimplencia</h1>
        <p className="text-sm mt-1" style={{ color: 'var(--text-secondary)' }}>Em desenvolvimento</p>
      </div>
      <div className="rounded-xl p-8 text-center" style={{ background: 'var(--card-bg)', border: '1px solid var(--card-border, rgba(255,255,255,0.08))', borderRadius: 12 }}>
